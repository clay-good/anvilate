...
relation, a satellite skimming 400 km up (orbital radius ~6,771 km) must travel about 7,673 m/s. The
...
gravitational parameter, and the low-orbit speed it implies.
...
def earth_gravity_chain() -> dict[str, float]:
    """Return the surface gravity, the gravitational parameter, and the low-orbit speed."""
