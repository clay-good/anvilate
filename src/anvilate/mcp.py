...
_SPEC_REF = "https://anvilate.dev/schemas/design-spec/1.16.0.json"
...
_SCORECARD_REF = "https://anvilate.dev/schemas/scorecard/1.10.0.json"
...
_BUNDLE_REF = "https://anvilate.dev/schemas/evidence-bundle/1.18.0.json"
