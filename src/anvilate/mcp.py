...
_SPEC_REF = "https://anvilate.dev/schemas/design-spec/1.14.0.json"
...
_SCORECARD_REF = "https://anvilate.dev/schemas/scorecard/1.9.0.json"
...
_BUNDLE_REF = "https://anvilate.dev/schemas/evidence-bundle/1.15.0.json"
