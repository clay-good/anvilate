...
50 mm), and the uppercase holes K/M/N/P via the ISO 286 delta rule — so the common
hole-basis fits (H7/g6, H8/f7, H9/d9, H7/js6, H7/k6, H7/n6, H7/p6, H7/r6, H7/s6,
...) and the shaft-basis K7/h6, N7/h6, M7/h6, P7/h6, S7/h6 resolve to limit
...
and the finer-stepped t/u (and r/s above 50 mm) land here as they are built out
(see openspec/specs/tolerance-management/).
"""
