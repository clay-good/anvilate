...
shaft, the finer-stepped r/s interference shafts (up to 50 mm), and the uppercase
holes K/M/N/P via the ISO 286 delta rule — so the common hole-basis fits (H7/g6,
H8/f7, H9/d9, H7/js6, H7/k6, H7/n6, H7/p6, H7/r6, H7/s6, ...) and the shaft-basis
K7/h6, N7/h6, M7/h6, P7/h6 resolve to limit deviations. It also ships the three
explicit per-dimension tolerance forms a spec can declare — symmetric ±,
...
Carlo) over a chain of those bands with ranked per-contributor sensitivities and
predicted yield. The grade-dependent letter j, the r/s holes, and t/u (and r/s
above 50 mm) land here as they are built out (see
