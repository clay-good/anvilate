...
INTERFACE_CANDIDATES_SCHEMA_VERSION = "1.5.0"
...
def interface_candidates_json_schema() -> dict[str, Any]:
    ...
    return _artifact(
        ...
        description=(
            ...
            "from imported solids, with measured solid summaries and exact coplanar contact "
            "candidates on multi-solid inputs. "
