...
def test_project_appraisal_example():
    ...
    # NPV ~$6862, B/C ~1.137, $5000/yr depreciation.
...
def test_project_economics_example():
    ...
    # 8%: PV $6805.83, FV back to $10000, annuity $6710.08.
...
def test_clean_card_example_passes_and_still_names_four_unchecked_modes():
