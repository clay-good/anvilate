...
hand-verified, 5,705 tests), ISO 286 fits, tolerance stack-ups, DFM process-capability
...
| [Margin ledger](docs/margin-ledger.md) | Every conservatism on a quantity recorded with its kind, origin and authority, multiplied out, with the code-required product beside it and same-kind factors from two origins named as a possible double count. The contract and arithmetic ship today; screens do not yet record into it. |
