...
reducing them to diameter, count, and size. Concentric pilot bores and locating bosses are
offered as separate candidates and enter the contract only when their exact ID is confirmed.
Blind holes, counterbores, and nonconcentric locators remain explicit detector limits.
...
hand-verified, 5,598 tests), ISO 286 fits, tolerance stack-ups, DFM process-capability
