...
500 runnable examples, each executed in CI so they stay honest. A few:
...
hand-verified, 5,908 tests), ISO 286 fits, tolerance stack-ups, DFM process-capability
...
Eight cross-cutting layers keep a green from being a silent one, an over-earned one, or one
nobody can act on.
