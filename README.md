...
allowable clearance. `--accept-mate` records the exact bore/shaft endpoints, measurements,
...
hand-verified, 5,643 tests), ISO 286 fits, tolerance stack-ups, DFM process-capability
