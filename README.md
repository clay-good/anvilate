...
single-solid JSON remains unchanged. Its output is a proposal only. Creating a contract
...
hand-verified, 5,604 tests), ISO 286 fits, tolerance stack-ups, DFM process-capability
