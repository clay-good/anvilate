...
504 runnable examples, each executed in CI so they stay honest. A few:
...
(237 closed-form modules and 1,843 public symbols, each dimension-checked and
hand-verified, 6,053 tests), ISO 286 fits, tolerance stack-ups, DFM process-capability
