...
- **1.1 is a ratchet, not a flag day.** Requiring an edition on every citation at once
  ...
  new citation must carry an edition and a paid-off one must come off the list. It stood
  at two entries when the gate landed, because the pack references were already in good
  shape — 13 of 16 carried an edition.
