...
- [x] 5.2 Seal gland screening composing the existing o-ring set; gland at temperature
...
- [x] 10.2 Internal dissipation to internal rise, consumed by thermal and condensation
