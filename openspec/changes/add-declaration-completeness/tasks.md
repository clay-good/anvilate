...
- [x] 3.1 Declared depth on the spec, with the depths defined by what they screen
- [x] 3.2 Out-of-depth status, distinct from not-evaluated, counted separately on the card
- [x] 3.3 Raising depth re-reports newly required declarations in the same needs report
...
- [x] 5.1 Example: the same spec at concept depth and at full depth, side by side
- [x] 5.2 Profile authoring page, including the applicability declaration
