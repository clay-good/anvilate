...
(`openspec/changes/add-optomechanical-module`, 1.2, 1.4, 2.1, 2.2, 2.4, 3.1, 3.2, 3.3, 3.4, 3.5, 4.3, 4.4, 5.1, 5.2, 7.1, 7.2, 8.1, 8.2, 10.1, 10.2, 10.3, 10.4
and this scope page). Not built yet: angular units as a whole, preload change with
temperature and contact stress. The focus and pointing budgets are worked examples built on the existing budget type.
