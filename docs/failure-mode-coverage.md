...
four modes its declared facts reach and nothing on the card addresses.
...
declaring none declares one. It also caps the declares-none list, which may only shrink: 23
screens declare a mode today, and 58 declare none.
