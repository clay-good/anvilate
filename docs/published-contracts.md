...
| [`docs/api/schemas/step-interface-candidates.schema.json`](api/schemas/step-interface-candidates.schema.json) | planar mating faces, solid summaries, exact coplanar contacts, and regular through-hole patterns measured from imported STEP solids | `INTERFACE_CANDIDATES_SCHEMA_VERSION` |
