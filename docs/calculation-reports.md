...
counted on each test run, and the run prints the ratio: **38 of 62 cited clauses are
...
| `[debt]` | A formula whose derivation has not been written yet. Downward-only. | 20 |
