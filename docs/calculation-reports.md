...
run, and the run prints both ratios: **51 of 62 cited clauses fully worked, 57 of 62
...
| --- | --- | --- |
| `[debt]` | A closed form nobody has written down yet. The list is downward-only. | 1 |
