...
1,520 of the library's 1,785 public functions and substitutes each poison value one
parameter at a time. The remaining 265 are not exempt — they are unreached, which is a
...
A line-trace of the suite says **around 52% of the roughly 5,250 `raise` sites in the imported modules
