...
1,520 of the library's 1,788 public functions and substitutes each poison value one
parameter at a time. The remaining 268 are not exempt — they are unreached, which is a
