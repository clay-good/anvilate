...
1,507 of the library's 1,767 public functions and substitutes each poison value one
parameter at a time. The remaining 260 are not exempt — they are unreached, which is a
...
A line-trace of the suite says **around 52% of the roughly 5,000 `raise` sites in the imported modules
