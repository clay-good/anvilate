...
1,507 of the library's 1,768 public functions and substitutes each poison value one
parameter at a time. The remaining 261 are not exempt — they are unreached, which is a
