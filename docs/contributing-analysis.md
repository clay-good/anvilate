...
1,520 of the library's 1,787 public functions and substitutes each poison value one
parameter at a time. The remaining 267 are not exempt — they are unreached, which is a
