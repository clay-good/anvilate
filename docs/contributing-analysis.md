...
1,521 of the library's 1,790 public functions and substitutes each poison value one
parameter at a time. The remaining 269 are not exempt — they are unreached, which is a
